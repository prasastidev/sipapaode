...
<Modal title="Formulir Permohonan dan Pengajuan Kerjasama" bind:open={ModalFormulir}  autoclose={false}>
  <form class="space-y-6" method="post" >
   ...
   <label class="text-sm">Kategori Kerjasama:</label>
    ...
    <div>
      <button type="submit" value="submit" class="flex w-full h-10 mb-4 justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Kirim Permohonan</button>
    </div>     
  </form>  
